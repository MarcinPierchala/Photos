...
using Stripe;
using Photos.DataAccess.DbInitializer;
...
builder.Services.AddIdentity<IdentityUser, IdentityRole>().AddEntityFrameworkStores<ApplicationDbConext>().AddDefaultTokenProviders();
